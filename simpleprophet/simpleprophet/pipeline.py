...
FIRST_MODEL_DATES = {
    ...
    'Firefox iOS Global MAU': pd.to_datetime("2019-03-08").date(),
    ...
    'Firefox Echo Global MAU': pd.to_datetime("2019-03-08").date(),
    'Firefox Fire TV Global MAU': pd.to_datetime("2019-03-08").date(),
    'Fennec Global MAU': pd.to_datetime("2019-03-08").date(),
    'Focus Android Global MAU': pd.to_datetime("2019-03-08").date(),
    'Lockwise Android Global MAU': pd.to_datetime("2019-09-01").date(),

    'Firefox iOS Tier1 MAU': pd.to_datetime("2019-03-08").date(),
    ...
    'Firefox Echo Tier1 MAU': pd.to_datetime("2019-03-08").date(),
    'Firefox Fire TV Tier1 MAU': pd.to_datetime("2019-03-08").date(),
    'Fennec Tier1 MAU': pd.to_datetime("2019-03-08").date(),
